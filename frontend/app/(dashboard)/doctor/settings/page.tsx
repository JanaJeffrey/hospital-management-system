...
import { 
  ...
  Save, Trash2, LogOut, Stethoscope, Award
} from "lucide-react";

// ✅ FIXED: Correct Render URL
  ...
  const handleUpdateProfile = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/api/auth/update-profile`, {
        ...
        body: JSON.stringify({ name, email, licenseNumber, specialization })
      });
  ...
  return (
    <div className="space-y-6 max-w-3xl mx-auto">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold" style={{ color: "var(--text)" }}>Doctor Settings</h1>
      ...
      <div className="rounded-2xl" style={{ backgroundColor: "var(--card)", border: "1px solid var(--border)" }}>
        ...
        <form onSubmit={handleUpdateProfile} className="p-5 space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium mb-1" style={{ color: "var(--text)" }}>License Number</label>
            <div className="relative">
              <Award className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4" style={{ color: "var(--text-light)" }} />
              <input
                type="text"
                value={licenseNumber}
          ...
          <div>
            ...
            <div className="relative">
              <Stethoscope className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4" style={{ color: "var(--text-light)" }} />
              <input
                type="text"
